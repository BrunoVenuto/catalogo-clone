...
export default function FloatingCTA() {
  ...
  return (
    <>
      {/* BOTÃO FLUTUANTE */}
      <div className="fixed bottom-6 right-6 md:bottom-24 md:right-[104px] z-50">
        <motion.button
        ...
        >
          {/* Pulse Effect */}
          <span className="absolute inset-0 border-2 border-green-500 rounded-full animate-ping opacity-75"></span>
