  ...
  return (
    <section id="home" className="relative w-full bg-transparent overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto flex flex-col md:flex-row items-stretch min-h-[70vh] md:min-h-[600px] shadow-sm">
        ...
        {/* Left Area - Text */}
        <div className="w-full md:w-1/2 flex flex-col justify-center items-start p-8 md:p-12 lg:p-16 bg-transparent shrink-0 relative overflow-hidden">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-mega-orange italic uppercase tracking-tighter leading-none mb-4">
              ...
              <span className="block text-white">{siteConfig.hero.title.split(' ')[1] || 'RACK'}</span>
            </h1>
